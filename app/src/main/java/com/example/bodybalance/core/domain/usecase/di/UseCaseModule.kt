...
import com.example.bodybalance.core.domain.usecase.impl.GetAllPlaylistVideoFlowUseCaseImpl
...
public abstract class UseCaseBinder {
    ...
    public abstract fun bindGetAllVideosUseCaseImpl(
        getAllSavedVideosUseCaseImpl: GetAllPlaylistVideoFlowUseCaseImpl
